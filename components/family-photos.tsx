...
const FamilyPhotos = () => {
  ...
  // Array con las 10 fotos familiares usando placeholders temáticos
  const photos = [
    {
      id: 1,
      src: "/placeholder.svg?height=600&width=800&query=familia reunida celebrando momentos especiales",
      alt: "Familia reunida",
      caption: "Momentos especiales en familia",
    },
    {
      id: 2,
      src: "/placeholder.svg?height=600&width=800&query=celebración familiar con sonrisas y alegría",
      alt: "Celebración familiar",
      caption: "Celebrando juntos",
    },
    {
      id: 3,
      src: "/placeholder.svg?height=600&width=800&query=reunión familiar unida con amor",
      alt: "Reunión familiar",
      caption: "Unidos siempre",
    },
    {
      id: 4,
      src: "/placeholder.svg?height=600&width=800&query=momentos inolvidables en familia",
      alt: "Momentos en familia",
      caption: "Recuerdos inolvidables",
    },
    {
      id: 5,
      src: "/placeholder.svg?height=600&width=800&query=familia feliz con sonrisas radiantes",
      alt: "Familia feliz",
      caption: "Sonrisas que perduran",
    },
    {
      id: 6,
      src: "/placeholder.svg?height=600&width=800&query=tiempo de calidad en familia",
      alt: "Tiempo en familia",
      caption: "Amor incondicional",
    },
    {
      id: 7,
      src: "/placeholder.svg?height=600&width=800&query=familia unida con lazos fuertes",
      alt: "Familia unida",
      caption: "Lazos que nos unen",
    },
    {
      id: 8,
      src: "/placeholder.svg?height=600&width=800&query=momentos familiares como tesoros",
      alt: "Momentos familiares",
      caption: "Tesoros del corazón",
    },
    {
      id: 9,
      src: "/placeholder.svg?height=600&width=800&query=familia completa con historia compartida",
      alt: "Familia completa",
      caption: "Nuestra historia",
    },
    {
      id: 10,
      src: "/placeholder.svg?height=600&width=800&query=familia querida con amor eterno",
      alt: "Familia querida",
      caption: "Amor eterno",
    },
  ]
